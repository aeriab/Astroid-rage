...
func _process(_delta):
	...
	if Input.is_action_just_pressed("switch") && Global.gameTimeScale > 0.1:
		...
		if Global.num_base_stars2 == 1:
			shootBall(mutation_part_2)
		elif Global.num_base_stars2 == 2:
			shootBall(mutation_part_3_1_)
			shootBall(mutation_part_3_2_)
		elif Global.num_base_stars2 == 3:
			shootBall(mutation_part_4_1_)
			shootBall(mutation_part_4_2_)
			shootBall(mutation_part_2)
		elif Global.num_base_stars2 == 4:
			shootBall(mutation_part_5_1_)
			shootBall(mutation_part_5_2_)
			shootBall(mutation_part_5_3_)
			shootBall(mutation_part_5_4_)
		elif Global.num_base_stars2 == 5:
			shootBall(mutation_part_2)
			shootBall(mutation_part_3_1_)
			shootBall(mutation_part_3_2_)
			shootBall(mutation_part_6_1_)
			shootBall(mutation_part_6_5_)
